...
trait AltTypes { this: Tidy =>
  ...
  private class AltBothOption[F[_ <: Rep] <: HNonEmpty, G[_ <: Rep] <: HNonEmpty](leftType: SingletonOption[F], rightType: SingletonOption[G]) extends AltType[SingletonOptionType[F], SingletonOptionType[G], AltBothOptionType[F, G]] with SingletonOption[AltSingleton[F, G]] {
  ...
  private class AltBothLeftOption[F[_ <: Rep] <: HNonEmpty, G[_ <: Rep] <: HNonEmpty](leftType: SingletonOption[F], rightRegex: Tidiable[G]) extends AltType[SingletonOptionType[F], G, AltBothLeftOptionType[F, G]] with SingletonOption[AltSingleton[F, G]] {
    override def innerType(using Quotes): Type[AltSingleton[F, G]] = {
      given Type[F] = leftType.innerType
  ...
  private class AltBothRightOption[F[_ <: Rep] <: HNonEmpty, G[_ <: Rep] <: HNonEmpty](leftRegex: Tidiable[F], rightType: SingletonOption[G]) extends AltType[F, SingletonOptionType[G], AltBothRightOptionType[F, G]] with SingletonOption[AltSingleton[F, G]] {
    override def innerType(using Quotes): Type[AltSingleton[F, G]] = {
